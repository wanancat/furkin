...
- `AGENTS.md`
- `docs/code_review_1.20.1-0.0.2.0/contract_precondition_workflow.md`

其中 `docs/code_review_1.20.1-0.0.2.0/contract_precondition_workflow.md` 是未跟踪文档，不能被视为已经落地的安全修复，也不能据此认为契约前置问题已经解决。
...
- `AGENTS.md` 已加入同样的长期约束，完整包清单见 `docs/code_review_1.20.1-0.0.2.0/wp-04_protocol_version_governance.md`。
