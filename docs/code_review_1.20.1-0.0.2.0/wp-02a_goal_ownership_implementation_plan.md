...
- `docs/code_review_1.20.1-0.0.2.0/wp-02_ai_ownership_unbind_design.md` 记录实际签名和事件顺序结论。
- `docs/code_review_1.20.1-0.0.2.0/code_review_2026-09-24_workflow.md` 更新 WP-02A 执行状态。
