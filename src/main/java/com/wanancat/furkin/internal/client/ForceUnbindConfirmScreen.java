...
public final class ForceUnbindConfirmScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(new Button(cx - 112, y, 108, 20,
                Component.translatable("furkin.screen.force_unbind.confirm"),
                btn -> confirm()));

        addRenderableWidget(new Button(cx + 4, y, 108, 20,
    ...
    public void render(PoseStack pose, int mouseX, int mouseY, float partialTick) {
        ...
        GuiComponent.drawCenteredString(pose, this.font, this.title, cx, y, 0xFFFFFF);
